...
const (
	...
	EventType_RECEIVE EventType = 1
	EventType_FORWARD EventType = 2
)
...
const (
	FailReason_AMOUNT_BELOW_MINIMUM        FailReason = 0
	FailReason_HTLC_TOO_BIG                FailReason = 1
	FailReason_INSUFFICIENT_BALANCE        FailReason = 2
	FailReason_LINK_NOT_ELIGIBLE           FailReason = 3
	FailReason_CANNOT_ENCODE_ROUTE         FailReason = 4
	FailReason_UNKNOWN_NEXT_PEER           FailReason = 5
	FailReason_PERMANENT_CHANNEL_FAIL      FailReason = 6
	FailReason_INVOICE_EXPIRY_TOO_SOON     FailReason = 7
	FailReason_EXPIRY_TOO_SOON             FailReason = 8
	FailReason_EXPIRY_TOO_FAR              FailReason = 9
	FailReason_CHANNEL_DISABLED            FailReason = 10
	FailReason_FINAL_AMOUNT_INCORRECT      FailReason = 11
	FailReason_INVOICE_UNDERPAID           FailReason = 12
	FailReason_FINAL_INCORRECT_CLTV        FailReason = 13
	FailReason_INVOICE_NOT_FOUND           FailReason = 14
	FailReason_HODL_INVOICE_CANCELLED      FailReason = 15
	FailReason_INVALID_ONION_PAYLOAD       FailReason = 16
	FailReason_INVOICE_ALREADY_CANCELLED   FailReason = 17
	FailReason_TEMPORARY_CHANNEL_FAILURE   FailReason = 18
	FailReason_INSUFFICIENT_FEE            FailReason = 19
	FailReason_INCORRECT_CLTV              FailReason = 20
	FailReason_INCORRECT_DETAILS           FailReason = 21
	FailReason_CANNOT_ENCODE_ONION_FAILURE FailReason = 22
	FailReason_ON_CHAIN_TIMEOUT            FailReason = 23
	FailReason_INTERNAL_ADD_ERROR          FailReason = 24
	FailReason_MPP_INVOICE_NOT_OPEN        FailReason = 25
	FailReason_MPP_ADDRESS_MISMATCH        FailReason = 26
	FailReason_MPP_SET_TOTAL_MISMATCH      FailReason = 27
	FailReason_MPP_SET_TOTAL_TOO_LOW       FailReason = 28
	FailReason_MPP_SET_OVERPAID            FailReason = 29
)
...
var FailReason_name = map[int32]string{
	...
	3:  "LINK_NOT_ELIGIBLE",
	4:  "CANNOT_ENCODE_ROUTE",
	5:  "UNKNOWN_NEXT_PEER",
	6:  "PERMANENT_CHANNEL_FAIL",
	7:  "INVOICE_EXPIRY_TOO_SOON",
	8:  "EXPIRY_TOO_SOON",
	9:  "EXPIRY_TOO_FAR",
	10: "CHANNEL_DISABLED",
	11: "FINAL_AMOUNT_INCORRECT",
	12: "INVOICE_UNDERPAID",
	13: "FINAL_INCORRECT_CLTV",
	14: "INVOICE_NOT_FOUND",
	15: "HODL_INVOICE_CANCELLED",
	16: "INVALID_ONION_PAYLOAD",
	17: "INVOICE_ALREADY_CANCELLED",
	18: "TEMPORARY_CHANNEL_FAILURE",
	19: "INSUFFICIENT_FEE",
	20: "INCORRECT_CLTV",
	21: "INCORRECT_DETAILS",
	22: "CANNOT_ENCODE_ONION_FAILURE",
	23: "ON_CHAIN_TIMEOUT",
	24: "INTERNAL_ADD_ERROR",
	25: "MPP_INVOICE_NOT_OPEN",
	26: "MPP_ADDRESS_MISMATCH",
	27: "MPP_SET_TOTAL_MISMATCH",
	28: "MPP_SET_TOTAL_TOO_LOW",
	29: "MPP_SET_OVERPAID",
}

var FailReason_value = map[string]int32{
	"AMOUNT_BELOW_MINIMUM":        0,
	"HTLC_TOO_BIG":                1,
	"INSUFFICIENT_BALANCE":        2,
	"LINK_NOT_ELIGIBLE":           3,
	"CANNOT_ENCODE_ROUTE":         4,
	"UNKNOWN_NEXT_PEER":           5,
	"PERMANENT_CHANNEL_FAIL":      6,
	"INVOICE_EXPIRY_TOO_SOON":     7,
	"EXPIRY_TOO_SOON":             8,
	"EXPIRY_TOO_FAR":              9,
	"CHANNEL_DISABLED":            10,
	"FINAL_AMOUNT_INCORRECT":      11,
	"INVOICE_UNDERPAID":           12,
	"FINAL_INCORRECT_CLTV":        13,
	"INVOICE_NOT_FOUND":           14,
	"HODL_INVOICE_CANCELLED":      15,
	"INVALID_ONION_PAYLOAD":       16,
	"INVOICE_ALREADY_CANCELLED":   17,
	"TEMPORARY_CHANNEL_FAILURE":   18,
	"INSUFFICIENT_FEE":            19,
	"INCORRECT_CLTV":              20,
	"INCORRECT_DETAILS":           21,
	"CANNOT_ENCODE_ONION_FAILURE": 22,
	"ON_CHAIN_TIMEOUT":            23,
	"INTERNAL_ADD_ERROR":          24,
	"MPP_INVOICE_NOT_OPEN":        25,
	"MPP_ADDRESS_MISMATCH":        26,
	"MPP_SET_TOTAL_MISMATCH":      27,
	"MPP_SET_TOTAL_TOO_LOW":       28,
	"MPP_SET_OVERPAID":            29,
}
...
type HTLCEvent struct {
	//
	//HTLC key identifies HTLCs and can be used to match forward events to their
	//corresponding settle or fail event.
	HtlcKey *HTLCKey `protobuf:"bytes,1,opt,name=htlc_key,proto3" json:"htlc_key,omitempty"`
	// Timestamp is the time (unix epoch offset) that the event occurred.
...
func (m *HTLCEvent) GetHtlcKey() *HTLCKey {
	if m != nil {
		return m.HtlcKey
	}
	return nil
...
func (m *HTLCEvent) GetTimestamp() uint64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
type HTLCEvent_ForwardEvent struct {
	ForwardEvent *ForwardEvent `protobuf:"bytes,3,opt,name=forward_event,proto3,oneof"`
}

type HTLCEvent_ForwardFailEvent struct {
	ForwardFailEvent *ForwardFailEvent `protobuf:"bytes,4,opt,name=forward_fail_event,proto3,oneof"`
}

type HTLCEvent_SettleEvent struct {
	SettleEvent *SettleEvent `protobuf:"bytes,5,opt,name=settle_event,proto3,oneof"`
}

type HTLCEvent_LinkFailEvent struct {
	LinkFailEvent *LinkFailEvent `protobuf:"bytes,6,opt,name=link_fail_event,proto3,oneof"`
}
...
type HTLCKey struct {
	...
	//on. This value is zero for sends.
	IncomingChannel uint64 `protobuf:"varint,1,opt,name=incoming_channel,proto3" json:"incoming_channel,omitempty"`
	//
	//Outgoing channel is the channel that the outgoing HTLC left our node on.
	//This value is zero for receives.
	OutgoingChannel uint64 `protobuf:"varint,2,opt,name=outgoing_channel,proto3" json:"outgoing_channel,omitempty"`
	// Incoming index is the index of the incoming HTLC in the incoming channel.
	IncomingIndex uint64 `protobuf:"varint,3,opt,name=incoming_index,proto3" json:"incoming_index,omitempty"`
	// Outgoing index is the index of the outgoing HTLC in the outgoing channel.
	OutgoingIndex        uint64   `protobuf:"varint,4,opt,name=outgoing_index,proto3" json:"outgoing_index,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *HTLCKey) Reset()         { *m = HTLCKey{} }
func (m *HTLCKey) String() string { return proto.CompactTextString(m) }
func (*HTLCKey) ProtoMessage()    {}
func (*HTLCKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_77a6da22d6a3feb1, []int{139}
}

func (m *HTLCKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_HTLCKey.Unmarshal(m, b)
}
func (m *HTLCKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_HTLCKey.Marshal(b, m, deterministic)
}
func (m *HTLCKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTLCKey.Merge(m, src)
}
func (m *HTLCKey) XXX_Size() int {
	return xxx_messageInfo_HTLCKey.Size(m)
}
func (m *HTLCKey) XXX_DiscardUnknown() {
	xxx_messageInfo_HTLCKey.DiscardUnknown(m)
}

var xxx_messageInfo_HTLCKey proto.InternalMessageInfo

func (m *HTLCKey) GetIncomingChannel() uint64 {
	if m != nil {
		return m.IncomingChannel
	}
	return 0
}

func (m *HTLCKey) GetOutgoingChannel() uint64 {
	if m != nil {
...
func (m *HTLCKey) GetIncomingIndex() uint64 {
	if m != nil {
...
func (m *HTLCKey) GetOutgoingIndex() uint64 {
	if m != nil {
		return m.OutgoingIndex
	}
	return 0
}

type HTLCInfo struct {
	IncomingTimelock uint32 `protobuf:"varint,1,opt,name=incoming_timelock,proto3" json:"incoming_timelock,omitempty"`
	OutgoingTimelock uint32 `protobuf:"varint,2,opt,name=outgoing_timelock,proto3" json:"outgoing_timelock,omitempty"`
	IncomingAmount   uint64 `protobuf:"varint,3,opt,name=incoming_amount,proto3" json:"incoming_amount,omitempty"`
	OutgoingAmt      uint64 `protobuf:"varint,4,opt,name=outgoing_amt,json=outgoing_amount,proto3" json:"outgoing_amt,omitempty"`
	// Payment hash is the payment has of the HTLC.
	PaymentHash          []byte    `protobuf:"bytes,5,opt,name=payment_hash,proto3" json:"payment_hash,omitempty"`
	EventType            EventType `protobuf:"varint,6,opt,name=event_type,proto3,enum=lnrpc.EventType" json:"event_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *HTLCInfo) GetIncomingAmount() uint64 {
	if m != nil {
		return m.IncomingAmount
	}
	return 0
}

func (m *HTLCInfo) GetOutgoingAmt() uint64 {
	if m != nil {
		return m.OutgoingAmt
	}
	return 0
}

func (m *HTLCInfo) GetPaymentHash() []byte {
	if m != nil {
		return m.PaymentHash
	}
	return nil
...
func (m *HTLCInfo) GetEventType() EventType {
	if m != nil {
		return m.EventType
	}
...
type ForwardEvent struct {
	// HTLCInfo contains details about the HTLC that was forwarded.
	HtlcInfo             *HTLCInfo `protobuf:"bytes,1,opt,name=htlc_info,proto3" json:"htlc_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *ForwardEvent) GetHtlcInfo() *HTLCInfo {
	if m != nil {
		return m.HtlcInfo
	}
	return nil
...
type SettleEvent struct {
	// HTLCInfo contains details about the HTLC that was settled.
	HtlcInfo             *HTLCInfo `protobuf:"bytes,1,opt,name=htlc_info,proto3" json:"htlc_info,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
...
func (m *SettleEvent) GetHtlcInfo() *HTLCInfo {
	if m != nil {
		return m.HtlcInfo
	}
	return nil
...
type LinkFailEvent struct {
	// HTLCInfo contains details about the HTLC that was settled.
	HtlcInfo *HTLCInfo `protobuf:"bytes,1,opt,name=htlc_info,proto3" json:"htlc_info,omitempty"`
	// FailReason provides the reason that the HTLC failed.
	FailReason           FailReason `protobuf:"varint,2,opt,name=fail_reason,proto3,enum=lnrpc.FailReason" json:"fail_reason,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *LinkFailEvent) GetHtlcInfo() *HTLCInfo {
	if m != nil {
		return m.HtlcInfo
	}
	return nil
...
func (m *LinkFailEvent) GetFailReason() FailReason {
	if m != nil {
		return m.FailReason
	}
	return FailReason_AMOUNT_BELOW_MINIMUM
}
...
func init() {
	...
	proto.RegisterEnum("lnrpc.EventType", EventType_name, EventType_value)
	proto.RegisterEnum("lnrpc.FailReason", FailReason_name, FailReason_value)
	...
	proto.RegisterType((*SubscribeHTLCEventsRequest)(nil), "lnrpc.SubscribeHTLCEventsRequest")
	proto.RegisterType((*HTLCEvent)(nil), "lnrpc.HTLCEvent")
	proto.RegisterType((*HTLCKey)(nil), "lnrpc.HTLCKey")
	proto.RegisterType((*HTLCInfo)(nil), "lnrpc.HTLCInfo")
	proto.RegisterType((*ForwardEvent)(nil), "lnrpc.ForwardEvent")
	proto.RegisterType((*ForwardFailEvent)(nil), "lnrpc.ForwardFailEvent")
	proto.RegisterType((*SettleEvent)(nil), "lnrpc.SettleEvent")
	proto.RegisterType((*LinkFailEvent)(nil), "lnrpc.LinkFailEvent")
}

func init() { proto.RegisterFile("rpc.proto", fileDescriptor_77a6da22d6a3feb1) }

var fileDescriptor_77a6da22d6a3feb1 = []byte{
	// 9963 bytes of a gzipped FileDescriptorProto
	,
}
...
type LightningClient interface {
	...
	SubscribeHTLCEvents(ctx context.Context, in *SubscribeHTLCEventsRequest, opts ...grpc.CallOption) (Lightning_SubscribeHTLCEventsClient, error)
}
...
func (c *lightningClient) SubscribeHTLCEvents(ctx context.Context, in *SubscribeHTLCEventsRequest, opts ...grpc.CallOption) (Lightning_SubscribeHTLCEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Lightning_serviceDesc.Streams[10], "/lnrpc.Lightning/SubscribeHTLCEvents", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningSubscribeHTLCEventsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Lightning_SubscribeHTLCEventsClient interface {
	Recv() (*HTLCEvent, error)
	grpc.ClientStream
}

type lightningSubscribeHTLCEventsClient struct {
	grpc.ClientStream
}

func (x *lightningSubscribeHTLCEventsClient) Recv() (*HTLCEvent, error) {
	m := new(HTLCEvent)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	//SubscribeHTLCEvents creates a uni-directional stream from the server to
	//the client which delivers a stream a HTLC events.
	SubscribeHTLCEvents(*SubscribeHTLCEventsRequest, Lightning_SubscribeHTLCEventsServer) error
}
...
func _Lightning_SubscribeHTLCEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeHTLCEventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(LightningServer).SubscribeHTLCEvents(m, &lightningSubscribeHTLCEventsServer{stream})
}

type Lightning_SubscribeHTLCEventsServer interface {
	Send(*HTLCEvent) error
	grpc.ServerStream
}

type lightningSubscribeHTLCEventsServer struct {
	grpc.ServerStream
}

func (x *lightningSubscribeHTLCEventsServer) Send(m *HTLCEvent) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Lightning_SubscribeHTLCEvents_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "rpc.proto",
